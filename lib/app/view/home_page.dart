    ...
    return Scaffold(
      body: SingleChildScrollView(
        ...
        child: Container(
          ...
          constraints: const BoxConstraints(minWidth: laptop + 100),
            ...
            child: Column(
              children: [
                    ...
                    children: [
                      GestureDetector(
                        child: const BodyText(
                            text: "About us", fontSize: FontSizes.h4),
                      ),
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 25),
                        child: GestureDetector(
                          child: const BodyText(
                              text: "Contact us", fontSize: FontSizes.h4),
                        ),
                      ),
                    ],
                  ),
                        ...
                        child: Column(
                          ...
                          children: [
                            const Padding(
                              ...
                              child: HeadingText(
                                  text: "Welcome to Culero",
                                  fontColor: Colors.grey,
                                  fontSize: FontSizes.h1),
                            ),
                            HeadingText(
                                text: "Review, Reflect, Connect.",
                                fontColor:
                                    Theme.of(context).colorScheme.primary,
                                fontSize: 48),
                            const Padding(
                            ...
                            Column(
                              children: [
                                Icon(Icons.person_2_outlined,
                                    size: 50, color: bodyText3),
                                Padding(
                                  padding: EdgeInsets.all(16.0),
                                  child: HeadingText(
                                      text: "Discover", fontSize: FontSizes.h5),
                                ),
                                SizedBox(
                                  width: 220,
                                  child: BodyText(
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    child: const BodyText(
                        text: "Terms and Policy", fontSize: FontSizes.h4),
                  ),
                ),
              ],
            ),
